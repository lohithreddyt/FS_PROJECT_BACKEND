...
public class AuthController {
    ...
    public void sendOtp(@Valid @RequestBody SendOtpRequest request, HttpSession session) {
        authService.sendOtp(request, session);
    }

    @PostMapping("/otp/verify")
    public void verifyOtp(@Valid @RequestBody VerifyOtpRequest request, HttpSession session) {
        authService.verifyOtp(request, session);
    }
